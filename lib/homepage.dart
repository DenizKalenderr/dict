...
class _HomePageState extends State<HomePage> {
  final List<Map<String, dynamic>> _allwords = [
    {'id': 1, 'name': 'Mehmet', 'mean': 'Güvenilir, itimat edilen.'},
    {'id': 2, 'name': 'Ahmet', 'mean': 'Övgüye değer, methedilen.'},
    {'id': 3, 'name': 'Ali', 'mean': 'Yüce, yüksek.'},
    {'id': 4, 'name': 'Mustafa', 'mean': 'Seçilmiş, beğenilen.'},
    {'id': 5, 'name': 'Emir', 'mean': 'Buyruk, komut.'},
    {'id': 6, 'name': 'Yusuf', 'mean': 'Tanrı artırsın, arttırsın.'},
    {'id': 7, 'name': 'İbrahim', 'mean': 'Babası yüce, yüce babası.'},
    {'id': 8, 'name': 'Kerem', 'mean': 'Cömertlik, lütuf.'},
    {'id': 9, 'name': 'Can', 'mean': 'Yaşam, canlılık.'},
    {'id': 10, 'name': 'Ömer', 'mean': 'Uzun ömürlü, uzun yaşayan.'},
    {'id': 11, 'name': 'Fatma', 'mean': 'Sağlam, dayanıklı.'},
    {'id': 12, 'name': 'Ayşe', 'mean': 'Hayat, yaşam.'},
    {'id': 13, 'name': 'Emine', 'mean': 'Kutsal, temiz.'},
    {'id': 14, 'name': 'Zeynep', 'mean': 'güzellikle süslenmiş.'},
    {'id': 15, 'name': 'Hatice', 'mean': 'Kraliçe, lider.'},
    {'id': 16, 'name': 'Hülya', 'mean': 'Hayal, rüya.'},
    {'id': 17, 'name': 'Elif', 'mean': 'İslamın ilk harfi.'},
    {'id': 18, 'name': 'Aysel', 'mean': 'Ay suyu.'},
    {'id': 19, 'name': 'Meryem', 'mean': 'Deniz, okyanus.'},
    {'id': 20, 'name': 'Esra', 'mean': 'Yardım eden.'},
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color.fromARGB(97, 156, 121, 121),
      appBar: AppBar(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
                  ...
                  ? ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return Card(
                          ...
                          color: Color.fromARGB(0, 218, 100, 100),
                          elevation: 4,
                          margin: const EdgeInsets.symmetric(vertical: 10),
                          child: ListTile(
                            leading: const Icon(
                              Icons.stacked_bar_chart,
                              color: Color.fromARGB(255, 196, 156, 36),
                            ),
                            title: Text(
           ...
           : const Center(child: Text('İsim bulunamadı'),) ),
          ],
        ),
      ),
    );
